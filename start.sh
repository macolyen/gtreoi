...
PORT=53874
UUID=d9128352-4f04-4db4-b746-200f1a301c71
WebPage=https://bing.com
CaddyConfig=https://raw.githubusercontent.com/ macolyen /
gtreoi /main/etc/Caddyfile
XRayConfig=https://raw.githubusercontent.com/ macolyen /
gtreoi /main/etc/xray.json
